<h3>Register with TwoFA via sms</h3>
...
<form id="register-form" method="post">
    ...
    <br /><input name="phonenumber" type="text" placeholder="Enter your phone number" id="phonenumber" />
...
<script language="javascript">
    ...
    function sendCode(captchaToken) {
        ...
        const url = 'https://api.berlinsms.de/twofa/sendsms?' + params.toString();
...
if (isset($responseJson['error'])) {
    ...
    echo "<hr>twofa verifcation successful <br>" . $responseJson['verifiedAddress'] . " is the verified phone number";
}
